let g:airline#themes#solarline#palette = {}

function! airline#themes#solarline#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  ...
  if s:background == 'dark'
    ...
    let s:N2 = [s:base2, (s:tty ? s:base01 : s:base01), '']
  ...
  " Inactive, according to VertSplit in solarline
  ...
  let g:airline#themes#solarline#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#solarline#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#solarline#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#solarline#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#solarline#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#solarline#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#solarline#palette.normal_modified.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#solarline#palette.insert.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#solarline#palette.insert_modified.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarline#palette.visual.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#solarline#palette.visual_modified.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#solarline#palette.replace.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#solarline#palette.replace_modified.airline_warning =
        \ g:airline#themes#solarline#palette.normal.airline_warning

  let g:airline#themes#solarline#palette.tabline = {}

  let g:airline#themes#solarline#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#solarline#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#solarline#refresh()
